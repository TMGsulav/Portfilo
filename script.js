...
const skills = [
  ...
  { icon: "code", name: "JavaScript", level: 67, desc: "Basic to intermediate" },
  ...
  { icon: "brain", name: "Problem Solving", level: 87, desc: "Logical thinking" },
];
  ...
  <article class="project-card reveal-on-scroll" style="transition-delay:${i * 70}ms">
    ...
    <div class="project-body">
      ...
      <div class="project-links">
        <a href="#" class="project-link"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg> Live</a>
